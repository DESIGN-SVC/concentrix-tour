  ...
  return (
    <div className={cx("flex flex-col gap-14", "lg:grid lg:grid-cols-2")}>
      <div className="space-y-8">
        ...
        <Tabs.Root
          value={typeTab}
          onValueChange={(value) => setTypeTab(value as typeof typeTab)}
                ...
                className={cx(
                  ...
                  "font-bold",
                  {
                    "border-jade text-jade bg-blue-300":
                      ["Cobrança", "Tecnologia"].includes(el.type) &&
                      el.type === typeTab,
                    "border-yellow-500 text-gray-800 bg-yellow-400":
                      el.type === "CX" && el.type === typeTab,
                    "border-pink-700 text-pink-700 bg-pink-50":
                      ["Treinamento", "Apoio"].includes(el.type) &&
                      el.type === typeTab,
            ...
            <div
              className={cx(
                ...
                "animate-slide-in-bottom",
                {
                  ...
                  "bg-yellow-300 text-yellow-600": index === 1,
