        ...
        >
            <div className={cx("container", "grid", "lg:grid-cols-2 ")}>
                ...
                <article className="mt-12 lg:col-start-1 lg:row-start-2 lg:mt-0 lg:mb-auto" data-animation="up-2">
                    ...
                    >
                        A Concentrix é uma empresa global de tecnologia e
                        serviços totalmente integrados. No Brasil, contamos com
                        mais de 22 mil colaboradores e oferecemos jornadas
                        completas de ponta a ponta, impulsionando algumas das
                        marcas mais reconhecidas do mundo. No Brasil atuamos em
                        diversas regiões, com unidades em Barueri, Curitiba,
                        Fortaleza, Londrina, Ponta Grossa e São Paulo.
                    </p>
                    <Button
                    ...
                    {peoplesImg.map((el, index) => (
                        <li
                            ...
                            className={cx(
                                ...
                                "w-full max-w-40",
                                {
                                    "bg-blue-900 order-1 rounded-b-full":
                                        index === 0,
                                    "bg-orange-400 order-3 col-start-1 row-start-2":
                                        index === 1,
                                    "bg-pink-700 order-2 row-start-1":
                                        index === 2,
                                    "bg-jade order-4 rounded-t-full row-start-3":
                                        index === 3,
                                    "h-[19.5rem] rounded-full row-span-2": [
                                        1, 2,
                                    ].includes(index),
                        ...
                        >
                            <Image
                                ...
                                className={cx("absolute", "w-full h-full", {
                                    ...
                                    "scale-[170%] top-[-10px] -translate-x-10":
                                        index === 0,
                                    "scale-110": index === 1,
